...
<p align="center">
  ...
  <a href="https://github.com/jaab-tech/fluxrig/releases"><img src="https://img.shields.io/github/v/tag/jaab-tech/fluxrig?label=Version&color=green" alt="Version"></a>
</p>

> **The connectivity and protocol orchestration platform for distributed mission-critical infrastructure.**
...
2.  **The Rack**: The edge node that hosts and executes processing logic (Gears).
...
Open a new terminal and start the Rack:
```bash
./bin/fluxrig rack
```
